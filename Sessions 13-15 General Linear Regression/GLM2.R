...
spam[1,]
predict(spam.glm.main, newdata = spam[1,]) # log-odds of being spam for observation 1 = 0.4852312 
exp(predict(spam.glm.main, newdata = spam[1,])) # odds of being spam for observation 1 = 1.624551 
...
# to account for the intercept
length(spam.glm.main$coefficients)
...
#one unit increase in V57 we increase the prob. by 0.084%
#1.624551*(1+0.0008440195)
